...
exports.resetPasswordSuccessEmailTemplate = void 0;
const resetPasswordSuccessEmailTemplate = (name) => {
    const body = `
  <p>Just letting you know that your password has been successfully reset. You can now log in using your new password. </p>

  <p>If you have any other questions or concerns, please don’t hesitate to contact us. </p>
       `;
    const message = `
                    ...
                    <tr>
                        <td style="text-align:center; padding: 0 40px;">
                          <a href="javascript:void(0)" title="logo" target="_blank">
                            <img width="108.73px" height="30px" src="cid:logo" title="logo" alt="">
                          </a>
                        </td>
                    </tr>
                    <tr>
...
exports.resetPasswordSuccessEmailTemplate = resetPasswordSuccessEmailTemplate;
//# sourceMappingURL=resetPasswordSuccessEmailTemplate.js.map